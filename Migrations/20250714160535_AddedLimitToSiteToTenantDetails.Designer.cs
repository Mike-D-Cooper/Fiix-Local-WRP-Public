...
namespace LocalWRP.Migrations
{
    ...
    [Migration("20250714160535_AddedLimitToSiteToTenantDetails")]
    partial class AddedLimitToSiteToTenantDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Local_WRP.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Local_WRP.Data.TenantDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Local_WRP.Data.ApplicationUser", null)
                        .WithMany()
